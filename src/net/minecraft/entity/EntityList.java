...
public class EntityList
{
    ...
    public static void addMapping(Class par0Class, String par1Str, int par2)
    {
    	if(IDtoClassMapping.containsKey((Integer)par2))
    		par2 = CrashWConflicts.getFreeEntId(CrashWConflicts.entities, (Set<Integer>)IDtoClassMapping.keySet(), par2, par0Class.getName(), ((Class)IDtoClassMapping.get(par2)).getName());

...
public class EntityList
{
    ...
    {
    	id = RegistryTracker.registerEntity(p_75618_0_, id);
        ...
        else
        {
            ...
            IDtoClassMapping.put(Integer.valueOf(id), p_75618_0_);
            classToIDMapping.put(p_75618_0_, Integer.valueOf(id));
            stringToIDMapping.put(p_75618_1_, Integer.valueOf(id));
        }
    }
     ...
     */
    public static void addMapping(Class p_75614_0_, String p_75614_1_, int id, int p_75614_3_, int p_75614_4_)
    {
        addMapping(p_75614_0_, p_75614_1_, id);
        id = (Integer) classToIDMapping.get(p_75614_0_);
        //simulate the id that would come out of the registry
        entityEggs.put(Integer.valueOf(id), new EntityList.EntityEggInfo(id, p_75614_3_, p_75614_4_));
    }
